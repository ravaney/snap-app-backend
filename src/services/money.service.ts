        ...
        await transactionRepository.createWalletTransaction(
          {
            ...
            balanceAfterMinor: senderAccount.balanceMinor - data.amountMinor,
            status: "PENDING",
            direction: "DEBIT",
            idempotencyKey: `${data.idempotencyKey}-debit`,
            relatedWalletId: receiverAccount.id,
            completedAt: null,
      ...
      await transactionRepository.createWalletTransaction(
        {
          ...
          type: "TRANSFER",
          amountMinor: data.amountMinor,
          balanceAfterMinor: receiverAccount.balanceMinor + data.amountMinor,
          status: "COMPLETED",
          direction: "CREDIT",
          idempotencyKey: `${data.idempotencyKey}-credit`,
          relatedWalletId: senderAccount.id,
          description: data.description,
        ...
        await transactionRepository.createWalletTransaction(
          {
            ...
            type: "DEPOSIT",
            amountMinor: data.amountMinor,
            balanceAfterMinor: wallet.balanceMinor + data.amountMinor,
            status: "PENDING",
            direction: "CREDIT",
            idempotencyKey: `${data.idempotencyKey}-credit`,
